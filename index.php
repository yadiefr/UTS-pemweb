...
.astext {
    ...
    cursor: pointer;
        ...
        <meta name="description" content="Welcome To Sentraland . We are the Best resort located at Malappuram (Dist),Kerala. Please visit our website to know more about the different Kerala holiday packages we have on offer. We look forward to having you visit us ">
        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
        
        <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <link rel="icon" href="img/fav-.png" type="image/x-icon" />
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
        <title>Sentraland| Home </title>
        ...
        <section class="main_slider_area main_s_banner">
            <div class="book_table_area">
                ...
                <div class="container">
                    ...
                    <h4 class="book_single_one"><font color="#242424" size="5px" >WELCOME TO <br> <font color="#242424" size="6px"> SENTRALAND</font></font></h4>
                ...
                <div class="row introduction_inner">
                    <div class="col-md-6">
                        ...
                        <div class="introduction_img" style="padding-top:6% ">
                            ...
                            <img src="img/introduction-im.jpg" alt="">
                        ...
                        <div class="explor_item">
                            ...
                            <div class="explor_text">
                                ...
                                <div class="explor_footer">
                                    <div class="pull-left">
                                        <h3>Rp<?php echo $room_price1 ?><span>/ Day</span></h3>
                                    </div>
                                    <div><br><br>
                    ...
                    <div class="col-md-4 col-sm-6">
                        ...
                        <div class="explor_item">
                            ...
                            <div class="explor_text">
                                ...
                                <div class="explor_footer">
                                    <div class="pull-left">
                                        <h3>Rp<?php echo $room_price2; ?><span>/ Day</span></h3>
                                    </div>
                                    <div ><br><br>
