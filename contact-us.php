...
<html lang="en">
    <head>
        ...
        <title>Kairali Resort | Contact Us</title>
                        ...
                        <!-- Collect the nav links, forms, and other content for toggling -->
                         <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown submenu active"><a href="contact-us.php">Contact Us</a></li>
                            </ul>
                ...
                <div class="row get_contact_inner">
                    <div class="col-md-6">
                        ...
                        <form class="contact_us_form row m0" action="function/contact.php" method="post" id="contactForm" >
                            ...
                            <div class="form-group col-md-12">
                                <input type="number" class="form-control" id="number" name="number" placeholder="Phoen no." required>
                            </div>
                            <div class="form-group col-md-12">
                            ...
                            <div class="contact_info_list">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4>Location</h4>
                                        <p><?php echo  $fetch_array['resort_address']?><br /><a href=""> <font color ='#1177d0'> In Google Map</font></a></p>
                                    </div>
                                </div>
                                <div class="media">
                                    <div class="media-left">
                                    ...
                                    <div class="media-body">
                                        <h4>Email</h4>
                                        <a href="#"><?php echo $fetch_array['resort_email'] ; ?></a>
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4>Phone</h4>
                                        <a href="#">+91 <?php echo $fetch_array['resort_phno'] ; ?></a>
                                    </div>
